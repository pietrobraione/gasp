...
public class Quicksort {
	...
	public void sortWorstCase() {
		//final int[] worst10 = {7, 6, 8, 10, 9, 5, 1, 2, 4, 3};
		final int[] worst50 = {33, 32, 34, 37, 36, 35, 31, 27, 26, 28, 30, 29, 38, 46, 45, 47, 50, 49, 48, 44, 40, 39, 41, 43, 42, 25, 8, 7, 9, 11, 10, 6, 2, 1, 3, 5, 4, 12, 20, 19, 21, 24, 23, 22, 18, 14, 13, 15, 17, 16};
		//final int[] worst75 = {50, 51, 49, 48, 52, 55, 56, 54, 53, 47, 41, 40, 39, 42, 45, 46, 44, 43, 57, 69, 70, 68, 67, 71, 74, 75, 73, 72, 66, 60, 59, 58, 61, 64, 65, 63, 62, 38, 12, 13, 11, 10, 14, 17, 18, 16, 15, 9, 3, 2, 1, 4, 7, 8, 6, 5, 19, 31, 32, 30, 29, 33, 36, 37, 35, 34, 28, 22, 21, 20, 23, 26, 27, 25, 24};
